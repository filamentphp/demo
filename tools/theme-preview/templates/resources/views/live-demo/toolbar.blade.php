...
<aside class="live-demo-toolbar" data-live-demo-toolbar data-live-demo-scheme="{{ session()->pull('live-demo.scheme') }}" data-preview-theme="{{ $selection['theme'] }}" data-preview-compact="{{ $selection['compact'] ? 'true' : 'false' }}" aria-label="Theme preview">
    <button
