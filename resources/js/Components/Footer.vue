...
<template>
    <footer class="p-4 bg-gray-100 py-12 sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-6xl">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">East West Fashions</a>. All Rights Reserved.
            </span>
