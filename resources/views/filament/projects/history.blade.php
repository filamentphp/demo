                ...
                <li wire:key="activity-{{ $activity->id }}" class="relative flex gap-3 pb-6 last:pb-0">
                    ...
                    <details class="group min-w-0 flex-1 pt-0.5" @if (count($activity->changes ?? []) === 1) open @endif>
                        ...
                        <div class="flex flex-wrap items-baseline gap-x-2 gap-y-1">
                            ...
                            <span class="text-gray-500 dark:text-gray-400" title="{{ $title }}">{{ match ($activity->event) { 'project_created' => 'created the project', 'project_deleted' => 'archived the project', 'project_restored' => 'restored the project', 'task_created' => 'added a task', 'task_deleted' => 'deleted a task', default => 'updated the project' } }}</span>
