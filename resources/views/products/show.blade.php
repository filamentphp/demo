                ...
                <div class="container-fluid">
                    <div class="header-left">
                        ...
                        <a href="demo19.html" class="logo">
                            <img src="images/demos/demo19/logo.png" alt="logo" width="306" height="88" />
                        </a>
                        <!-- End Logo -->
                        <nav class="main-nav">
                            <ul class="menu">
                    ...
                    <div class="header-right">
                        ...
                        <!-- End Header Search -->
                        <a href="ajax/login.html" class="login-link d-lg-show mr-4"><i class="d-icon-user"></i></a>
                            ...
                            <div class="dropdown-box scrollable">
                                ...
                                <div class="products scrollable">
                                    ...
                                    <div class="product product-wishlist">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ $product->image ? asset('images/products/' . $product->image) : 'https://i.makeup.fr/i/i4/i4dfmpe8rxkj.png' }}" width="100" height="100"
                                                     alt="product" />
                                            </a>
                                            <button class="btn btn-link btn-close">
                                                <i class="fas fa-times"></i><span class="sr-only">Close</span>
                            ...
                            <div class="dropdown-box">
                                <div class="products scrollable">
                                    <div class="product product-cart">
                                        ...
                                        <div class="product-detail">
                                            <a href="demo19-product.html" class="product-name">Riode White Trends</a>
                                            <div class="price-box">
                                    ...
                                    <div class="product product-cart">
                                        ...
                                        <div class="product-detail">
                                            <a href="demo19-product.html" class="product-name">Dark Blue Women’s
                                                Leomora Hat</a>
                                            <div class="price-box">
                                                <span class="product-quantity">1</span>
...
{{--                                            BRAND: <span class="product-brand">{{$product->categories->name}}</span>--}}
                            ...
                            <section>
                                <h2 class="title title-link mb-4">Nouveaux arrivages
                                    <a href="#" class="btn btn-link btn-slide-right">Voir plus<i
