        ...
        <div class="header-top">
            <div class="container">
                <div class="header-left">
                    <p class="welcome-msg">Welcome to Muster & Dikson store message or remove it!</p>
                </div>
                                ...
                                <form wire:submit.prevent="submit">
                                    <div class="row mb-2">
                                        <div class="col-12 mb-4">
                                            <textarea class="form-control" wire:model="comment" required placeholder="Comment*"></textarea>
                                        </div>
