...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <main class="main home">
            <section class="category-menu-section container">
                <div class="p-relative">
                    <ul class="menu menu-options vertical-menu category-menu">
                        <li>
                            <a href="demo34-shop.html"><i class="d-icon-desktop"></i>Computer &amp;
                                Laptops</a>
                        </li>
                        <li>
                                    ...
                                    <div class="col-lg-4 p-0">
                                        <div class="menu-banner menu-banner3 banner banner-fixed">
                                            ...
                                            <div class="banner-content banner-date">
                                                <h6 class=" text-white font-weight-bold text-uppercase lh-1 mb-0">
                        ...
                        <li>
                            <a href="demo34-shop.html"><i class="d-icon-gamepad1"></i>Gaming Accessories</a>
                            <div class="megamenu">
                                <div class="row">
                                    <div class="col-lg-4">
                        ...
                        <li>
                            <a href="demo34-shop.html"><i class="d-icon-camera1"></i>Electronics</a>
                        </li>
                        <li>
                            <a href="demo34-shop.html"><i class="d-icon-cook"></i>Home &amp; Kitchen</a>
                        </li>
                        <li>
                            <a href="demo34-shop.html"><i class="d-icon-basketball2"></i>Sporting Goods</a>
                        </li>
                        <li>
                            <a href="demo34-shop.html"><i class="d-icon-handbag"></i>Backpack &amp; Bags</a>
                        </li>
                        <li>
                            <a href="demo34-shop.html"><i class="d-icon-babycare"></i>Toys &amp; Babycare</a>
                        </li>
                    </ul>
                </div>
            </section>
                    ...
                    <div class="row pb-4">
                        <div class="intro-slider animation-slider owl-carousel owl-dot-white owl-theme owl-dot-inner row cols-1 gutter-no mb-4"
                            ...
                            <div class="intro-slide1 banner banner-fixed" style="background-color: #EEF2F5">
                                <figure>
                                    <img src="images/demos/demo34/slides/1.jpg" alt="banner" width="1180"
                                         height="547" />
                                </figure>
                                <div class="banner-content y-50">
                                    <h4 class="banner-subtitle text-uppercase mb-3">From online Store</h4>
                                    <h3 class="banner-title font-weight-bold lh-1 ls-m mb-4">Highly Recommend <br> Mid
                                        season's
                                    </h3>
                                    ...
                                    <a href="demo34-shop.html" class="btn btn-rounded btn-dark">Shop now<i
                                            class="d-icon-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="intro-slide2 banner banner-fixed" style="background-color: #EAE8ED">
                                <figure>
                                    <img src="images/demos/demo34/slides/2.jpg" alt="banner" width="1180"
                                         height="547" />
                                </figure>
                                <div class="banner-content y-50">
                                    <h4 class="banner-subtitle text-uppercase mb-3">From online Store</h4>
                                    <h3 class="banner-title font-weight-bold lh-1 ls-m mb-4">Mid season Sale <br> For
                                        Women's
                                    </h3>
                                    <p class="banner-desc font-weight-normal lh-1 mb-8">
                                        <strong class="text-primary text-uppercase">Up To 10% Off</strong>
                        ...
                        <div class="col-lg-6 col-md-12 mb-4">
                            <div class="banner category-banner overlay-dark" style="background-color: #222;">
                                <figure>
                                    <img src="images/demos/demo34/banners/1.jpg" alt="banner" width="580" height="268">
                                </figure>
                                <div class="banner-content y-50">
                                    <h4 class="banner-subtitle text-uppercase font-weight-normal lh-1 text-white">New
                                        Collection
                                    </h4>
                                    <h3 class="banner-title font-weight-bold lh-1 text-white mb-5">Summer Sale</h3>
                                    <a href="demo34-shop.html"
                        ...
                        <div class="col-lg-6 col-md-12 mb-4">
                            <div class="banner category-banner overlay-dark" style="background-color: #E5E6E8;">
                                <figure>
                                    <img src="images/demos/demo34/banners/2.jpg" alt="banner" width="580" height="268">
                                </figure>
                                <div class="banner-content y-50">
                                    <h4 class="banner-subtitle text-uppercase font-weight-normal lh-1">Trending</h4>
                                    <h3 class="banner-title font-weight-bold lh-1 mb-5">Fashion Bags</h3>
                                    <a href="demo34-shop.html" class="btn btn-link btn-underline text-uppercase">Shop
                                        now<i class="d-icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                <div class="banner banner-sm" style="background-color: #CDCED3;">
                                    <figure>
                                        <img src="images/demos/demo34/banners/3.jpg" alt="banner" width="380"
                                             height="170">
                                    </figure>
                                    <div class="banner-content y-50">
                                ...
                                <div class="newsletter-form text-center">
                                    <h3 class="newsletter-title font-weight-bold text-uppercase ls-m mb-6">Sign Up To
                                        Our
                                        Newsletter</h3>
                            ...
                            <div class="col-lg-8 mb-3">
                                <div class="banner banner-lg" style="background-color: #544643;">
                                    <figure>
                                        <img src="images//demos/demo34/banners/4.jpg" alt="banner" width="780"
                                             height="457">
                                    </figure>
                                    <div class="banner-content y-50">
                                        <h4
                                            class="banner-subtitle text-white text-uppercase font-weight-bold ls-normal mb-3">
                                            Through Black Friday</h4>
                                        <h3 class="banner-title text-white font-weight-bold ls-normal lg-1">Mid Season's
                                            Sale<br>Up to 30% Off</h3>
                                        <p class="banner-desc text-white">Free shipping on all orders over $99.00</p>
                                        <a href="demo34-shop.html" class="btn btn-white btn-rounded text-uppercase">Shop
                                            Now<i class="d-icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
