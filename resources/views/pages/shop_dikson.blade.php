...
<div class="page-wrapper">
    ...
    <main class="main">
        <div class="page-header"
            ...
            <h1 class="page-title">Dikson Shop</h1>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="{{ route('product.show', $product->id) }}">
                                                <img src="{{ asset('images/products/' . $product->image) }}" alt="{{ $product->name }}" width="280" height="315">
                                            </a>
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="ratings-container">
                                                ...
                                                <a href="{{ route('product.show', $product->id) }}" class="rating-reviews">({{ $product->reviews_count }} Reviews)</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
